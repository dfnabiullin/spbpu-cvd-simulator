Консольная утилита для оптимизации размера графических файлов. Программа удаляет цветовую информацию, неразличимую для
людей с нарушениями цветовосприятия (дихромазией).

В результате обработки происходит проекция цветов на плоскость неразличимости, что снижает энтропию изображения и
